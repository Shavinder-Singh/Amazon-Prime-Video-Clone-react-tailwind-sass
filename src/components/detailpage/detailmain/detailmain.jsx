                        ...
                        <>
                            ...
                            <div className='movie_detail_wrapper text-white bg-black lg:px-[24px]'>
                                ...
                                <div className='ordering_content flex flex-col px-[24px] lg:px-[0px]'>
                                    <div className='movie_detail_options movie_detail_buttons flex flex-col gap-2 '>
                                        <span className='flex items-center gap-1 '>
                                            ...
                                            <span className='text-[15px] font-semibold tracking-wider prime_trial lg:text-[17px]'>Watch with a free Prime trial</span></span>
                                        <div className='flex flex-col gap-2 lg:flex-row lg:items-start lg:gap-8'>
                                            <div className='movie_details_btns  flex  flex-col gap-2'>
                                                <div className='movie_options_trial_btn py-1 rounded-lg tracking-widest bg-white text-black flex flex-col justify-center items-center font-bold'>
                                                ...
                                                <div className='movie_options_rent_btn py-[14.5px] rounded-lg tracking-widest bg-inputbgcolor text-white flex flex-col justify-center items-center font-bold'>
                                                    <button className=' text-[15px] md:text-[16px] tracking-wider mt-[-2px]'>Rent <span className='uhd_badge'>UHD ₹119</span></button>
                                                </div>
                                                <div className='movie_options_purchase_btn py-[14px] rounded-lg tracking-widest bg-inputbgcolor text-white flex flex-col justify-center items-center font-bold'>
