...
import PrimeLogo from '../../../assets/image/PrimecontentImage.png'
        ...
        <>
            <div className='movies_section pb-5 bg-primary'>
                ...
                <div className='movies_page_nav bg-primary text-white'>
                    <div className='flex items-center gap-6 pl-9 pt-[6px] pb-[20px] md:pb-[17px]'>
                        <div className='flex items-center gap-4 md:gap-5'>
                            ...
                            <a href='#' className='text-[15px] md:text-[16px] tracking-wider font-bold text-white'>Movies</a>
                        </div>
