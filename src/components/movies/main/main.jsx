...
import tiger from '../../../assets/image/tigermovie.png'
import aaablautchalen from '../../../assets/image/aaabblautchalen.jpg'
import spiderman from '../../../assets/image/spiderman.jpg'
import deewar from '../../../assets/image/deewar.jpg'
import jodha from '../../../assets/image/jodh.jpg'
            ...
            <div className='movies_section mb-5'>
                ...
                <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
                    <SwiperSlide className='relative'>
                        ...
                        <img src={tiger} alt="" className='rounded-2xl absolute -z-10' />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src={aaablautchalen} alt="" className='rounded-2xl absolute -z-10' />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src={spiderman} alt="" className='rounded-2xl absolute -z-10' />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src={deewar} alt="" className='rounded-2xl absolute -z-10' />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src={jodha} alt="" className='rounded-2xl absolute -z-10' />
                    </SwiperSlide>
                </Swiper>
