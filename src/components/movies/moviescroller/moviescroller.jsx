...
export default function App() {
    ...
    //redirect to specificCategory page
    const handleredirect = async (detailImdbIdSecond) => {
        try {
            const response = await fetch(`https://omdbapi.com/?s=${detailImdbIdSecond}&apikey=eae86d55`);
            const data = await response.json();
            if (data.Response === 'True') {
                navigate(`/SpecificCategory/${detailImdbIdSecond}`);
            } else {
                // setSelectedMovie(null);
            }
        } catch (error) {
    ...
    return (
        <>
            <div className='movies_page_wrapper'>
                <div className='movie_page pl-[24px] md:pl-[45px] lg:pl-[45px] pb-[170px] xl:pl-[65px] bg-black'>
                    <div className='movies_scroller bg-black text-white  mb-[43px] md:mb-[0px] relative' onMouseEnter={() => onmouseenters()}>
                        <div className='font-bold flex  pr-3 md:pr-0 gap-4 md:gap-4 md:pb-0 text-[15px] md:text-[18px] tracking-wide'>
                            ...
                            <div className='font-thin md:font-bold flex items-center gap-2 text-nowrap'><span onClick={() => handleredirect('kids')} className='cursor-pointer'>See more</span><span>
                        ...
                        >
                            {mystery && mystery.map((data, index) => (
                                <SwiperSlide className='swiper_slide relative mt-5 md:mt-0' key={data.imdbID} onMouseEnter={() => handleclick(data.imdbID)} onClick={() => handledetail(data.imdbID)}><img src={data.Poster} />
                    ...
                    <div className='movie_scroller bg-black text-white mb-[43px]  md:mb-[0px] relative ' onMouseEnter={() => zIndexchange()}>
                        <div className='font-bold pr-3 md:pr-0 flex gap-4 md:gap-4 pb- md:pb-0 text-[16px] md:text-[18px] tracking-wide'>
                            <div className='flex items-center'><h1><span className='text-azonblue'>Prime</span> Romance Movies</h1></div>
                            <div className='font-thin md:font-bold flex items-center gap-2 text-nowrap'><span  onClick={() => handleredirect('romance')} className='cursor-pointer'>See more</span><span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" id="right-arrow"><path fill="white" d="M13.8 24.196a1 1 0 0 0 1.414 0L21.7 17.71a.992.992 0 0 0 .292-.71.997.997 0 0 0-.292-.71l-6.486-6.486a1 1 0 0 0-1.414 1.414L19.582 17 13.8 22.782a1 1 0 0 0 0 1.414z"></path></svg>
                            </span></div>
                        </div>
                        <Swiper
                        ...
                        >
                            {romantic && romantic.map((data, index) => (
                                <SwiperSlide className='swiper_slide relative mt-5 md:mt-0' key={data.imdbID} onMouseEnter={() => handleclick(data.imdbID)} onClick={() => handledetail(data.imdbID)}><Link to="/detailpage" className='w-full h-full'><img src={data.Poster} /></Link>
                    ...
                    {/* second */}
                    <div className='movies_scroller bg-black text-white mt-12 mb-[43px] md:mb-[0px] relative' onMouseEnter={() => onmouseenters()}>
                        <div className='font-bold flex pr-3 md:pr-0 gap-4 md:gap-4 md:pb-0 text-[15px] md:text-[18px] tracking-wide'>
                            <div className=' flex-wrap flex items-center'><span className='text-azonblue mr-1'>Prime</span> <span>   Horror Movies</span></div>
                            <div className='font-thin md:font-bold flex items-center gap-2 text-nowrap'><span  onClick={() => handleredirect('horror')} className='cursor-pointer'>See more</span><span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" id="right-arrow"><path fill="white" d="M13.8 24.196a1 1 0 0 0 1.414 0L21.7 17.71a.992.992 0 0 0 .292-.71.997.997 0 0 0-.292-.71l-6.486-6.486a1 1 0 0 0-1.414 1.414L19.582 17 13.8 22.782a1 1 0 0 0 0 1.414z"></path></svg>
                            </span></div>
                        </div>
                        <Swiper
                    ...
                    <div className='movie_scroller bg-black text-white mb-[43px]  md:mb-[0px] relative ' onMouseEnter={() => zIndexchange()}>
                        <div className='font-bold pr-3 md:pr-0 flex gap-4 md:gap-4 pb-2 md:pb-0 text-[16px] md:text-[18px] tracking-wide'>
                            <div className='flex items-center'><h1><span className='text-azonblue'>Prime</span> Historical Movies</h1></div>
                            <div className='font-thin md:font-bold flex items-center gap-2 text-nowrap'><span  onClick={() => handleredirect('historical')} className='cursor-pointer'>See more</span><span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" id="right-arrow"><path fill="white" d="M13.8 24.196a1 1 0 0 0 1.414 0L21.7 17.71a.992.992 0 0 0 .292-.71.997.997 0 0 0-.292-.71l-6.486-6.486a1 1 0 0 0-1.414 1.414L19.582 17 13.8 22.782a1 1 0 0 0 0 1.414z"></path></svg>
                            </span></div>
                        </div>
                        <Swiper
                    ...
                    <div className='movies_scroller bg-black text-white   mb-[43px] md:mb-[0px] relative' onMouseEnter={() => onmouseenters()}>
                        <div className='font-bold flex  pr-3 md:pr-0 gap-4 md:gap-4 md:pb-0 text-[15px] md:text-[18px] tracking-wide'>
                            ...
                            <div className='font-thin md:font-bold flex items-center gap-2 text-nowrap'><span  onClick={() => handleredirect('action')} className='cursor-pointer'>See more</span><span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" id="right-arrow"><path fill="white" d="M13.8 24.196a1 1 0 0 0 1.414 0L21.7 17.71a.992.992 0 0 0 .292-.71.997.997 0 0 0-.292-.71l-6.486-6.486a1 1 0 0 0-1.414 1.414L19.582 17 13.8 22.782a1 1 0 0 0 0 1.414z"></path></svg>
                            </span></div>
                        </div>
                        <Swiper
                    ...
                    <div className='movie_scroller bg-black text-white mb-[43px]  md:mb-[0px] relative ' onMouseEnter={() => zIndexchange()}>
                        <div className='font-bold pr-3 md:pr-0 flex gap-4 md:gap-4 pb-2 md:pb-0 text-[16px] md:text-[18px] tracking-wide'>
                            <div className='flex items-center'><h1><span className='text-azonblue'>Prime</span> Hindi Movies</h1></div>
                            <div className='font-thin md:font-bold flex items-center gap-2 text-nowrap'><span  onClick={() => handleredirect('hindi')} className='cursor-pointer'>See more</span><span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" id="right-arrow"><path fill="white" d="M13.8 24.196a1 1 0 0 0 1.414 0L21.7 17.71a.992.992 0 0 0 .292-.71.997.997 0 0 0-.292-.71l-6.486-6.486a1 1 0 0 0-1.414 1.414L19.582 17 13.8 22.782a1 1 0 0 0 0 1.414z"></path></svg>
                            </span></div>
                        </div>
                        <Swiper
                    ...
                    <div className='movies_scroller bg-black text-white   mb-[43px] md:mb-[0px] relative' onMouseEnter={() => onmouseenters()}>
                        <div className='font-bold flex  pr-3 md:pr-0 gap-4 md:gap-4 md:pb-0 text-[15px] md:text-[18px] tracking-wide'>
                            ...
                            <div className='font-thin md:font-bold flex items-center gap-2 text-nowrap'><span  onClick={() => handleredirect('punjabi')} className='cursor-pointer'>See more</span><span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" id="right-arrow"><path fill="white" d="M13.8 24.196a1 1 0 0 0 1.414 0L21.7 17.71a.992.992 0 0 0 .292-.71.997.997 0 0 0-.292-.71l-6.486-6.486a1 1 0 0 0-1.414 1.414L19.582 17 13.8 22.782a1 1 0 0 0 0 1.414z"></path></svg>
                            </span></div>
                        </div>
                        <Swiper
                    ...
                    <div className='movie_scroller bg-black text-white mb-[43px] md:mb-[0px] relative ' onMouseEnter={() => zIndexchange()}>
                        <div className='font-bold pr-3 md:pr-0 flex gap-4 md:gap-4 pb-2 md:pb-0 text-[16px] md:text-[18px] tracking-wide'>
                            <div className='flex items-center'><h1><span className='text-azonblue'>Prime</span> Drama Movies</h1></div>
                            <div className='font-thin md:font-bold flex items-center gap-2 text-nowrap'><span  onClick={() => handleredirect('drama')} className='cursor-pointer'>See more</span><span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" id="right-arrow"><path fill="white" d="M13.8 24.196a1 1 0 0 0 1.414 0L21.7 17.71a.992.992 0 0 0 .292-.71.997.997 0 0 0-.292-.71l-6.486-6.486a1 1 0 0 0-1.414 1.414L19.582 17 13.8 22.782a1 1 0 0 0 0 1.414z"></path></svg>
                            </span></div>
                        </div>
                        <Swiper
