...
export default function App() {
    ...
    return (
        <>
            <div className='movies_scroller bg-black text-white pl-[25px] md:pl-[26px] mb-[43px]  md:mb-[0px] relative' onMouseEnter={() => onmouseenters()}>
                                    ...
                                    {datas && ((
                                        <>
                                            ...
                                            <div className='flex justify-between gap-1 text-[11px]  lg:text-[14px] font-bold px-2 lg:px-5 text-left mb-2'>
                                                ...
                                                <p className='text-white'>{datas.Rated}
            ...
            <div className='movie_scroller bg-black text-white pl-[25px] md:pl-[26px] mb-[43px] md:mb-[0px] relative ' onMouseEnter={() => zIndexchange()}>
                <div className='font-bold flex gap-2 md:gap-4 pb-2 md:pb-0 text-[16px] md:text-[18px] tracking-wide'>
                    <div><h1><span className='text-azonblue'>Prime</span> Second </h1></div>
                    <div className='font-thin md:font-bold flex items-center gap-2'><span>See more</span><span>
                        <img src={rightarrow} width="13px" />
                    </span></div>
                </div>
