                ...
                <div className='movies_scroller bg-black text-white  mb-[43px] md:mb-[0px] relative' onMouseEnter={() => onmouseenters()}>
                    ...
                    >
                        {mystery && mystery.map((data, index) => (
                            <>
                                <SwiperSlide className='swiper_slide relative flex flex-col mt-5 md:mt-0' key={data.imdbID} onMouseEnter={() => handleclick(data.imdbID)} onClick={() => handledetail(data.imdbID)}><img src={data.Poster} />
