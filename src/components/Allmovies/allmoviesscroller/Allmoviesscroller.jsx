...
export default function AllMoviesscroller() {
    ...
    useEffect(() => {
        axios.get(`https://www.omdbapi.com/?s=new&type=movie&genre=${genre}&apikey=eae86d55`)
            .then(function (response) {
    ...
    useEffect(() => {
        axios.get(`https://www.omdbapi.com/?s=historical&type=movie&genre=${genre}&apikey=eae86d55`)
            .then(function (response) {
    ...
    useEffect(() => {
        axios.get(`https://www.omdbapi.com/?s=horror&type=movie&genre=${genre}&apikey=eae86d55`)
            .then(function (response) {
    ...
    useEffect(() => {
        axios.get(`https://www.omdbapi.com/?s=action&type=movie&genre=${genre}&apikey=eae86d55`)
            .then(function (response) {
    ...
    useEffect(() => {
        axios.get(`https://www.omdbapi.com/?s=hindi&type=movie&genre=${genre}&apikey=eae86d55`)
            .then(function (response) {
    ...
    useEffect(() => {
        axios.get(`https://www.omdbapi.com/?s=punjabi&type=movie&genre=${genre}&apikey=eae86d55`)
            .then(function (response) {
    ...
    useEffect(() => {
        axios.get(`https://www.omdbapi.com/?s=drama&type=movie&genre=${genre}&apikey=eae86d55`)
            .then(function (response) {
    ...
    useEffect(() => {
        axios.get(`https://www.omdbapi.com/?s=romance&type=movie&genre=${genre}&apikey=eae86d55`)
            .then(function (response) {
            ...
            <div className='movie_page pl-[24px] md:pl-[45px] lg:pl-[45px] pb-[170px] xl:pl-[65px] bg-black'>
                <div className='movies_scroller bg-black text-white  mb-[43px] md:mb-[0px] relative' onMouseEnter={() => onmouseenters()}>
                    <div className='font-bold flex  pr-3 md:pr-0 gap-4 md:gap-4 md:pb-0 text-[15px] md:text-[18px] tracking-wide'>
                        ...
                        <div className='font-thin md:font-bold flex items-center gap-2 text-nowrap cursor-pointer' onClick={() => handleredirect('kids')} ><span>See more</span><span>
                ...
                <div className='movie_scroller bg-black text-white  mb-[43px] md:mb-[0px] relative ' onMouseEnter={() => zIndexchange()}>
                    <div className='font-bold pr-3 md:pr-0 flex gap-4 md:gap-4 pb-2 md:pb-0 text-[16px] md:text-[18px] tracking-wide'>
                        <div className='flex items-center flex-wrap'><h1><span className='text-azonblue'>Prime</span> New Movies</h1></div>
                        <div className='font-thin md:font-bold flex items-center gap-2 text-nowrap cursor-pointer' onClick={() => handleredirect('New')} ><span>See more</span><span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" id="right-arrow"><path fill="white" d="M13.8 24.196a1 1 0 0 0 1.414 0L21.7 17.71a.992.992 0 0 0 .292-.71.997.997 0 0 0-.292-.71l-6.486-6.486a1 1 0 0 0-1.414 1.414L19.582 17 13.8 22.782a1 1 0 0 0 0 1.414z"></path></svg>
                        </span></div>
                    </div>
                    <Swiper
                        ...
                        className="mySwiperpagination "
                    >
                        {newmovies && newmovies.map((data, index) => (
                ...
                <div className='movies_scroller bg-black text-white   mb-[43px] md:mb-[0px] relative' onMouseEnter={() => onmouseenters()}>
                    <div className='font-bold flex  pr-3 md:pr-0 gap-4 md:gap-4 md:pb-0 text-[15px] md:text-[18px] tracking-wide'>
                        ...
                        <div className='font-thin md:font-bold flex items-center gap-2 text-nowrap cursor-pointer' onClick={() => handleredirect('Horror')} ><span>See more</span><span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" id="right-arrow"><path fill="white" d="M13.8 24.196a1 1 0 0 0 1.414 0L21.7 17.71a.992.992 0 0 0 .292-.71.997.997 0 0 0-.292-.71l-6.486-6.486a1 1 0 0 0-1.414 1.414L19.582 17 13.8 22.782a1 1 0 0 0 0 1.414z"></path></svg>
                        </span></div>
                    </div>
                    <Swiper
                ...
                <div className='movie_scroller bg-black text-white  mb-[43px]  md:mb-[0px] relative ' onMouseEnter={() => zIndexchange()}>
                    <div className='font-bold pr-3 md:pr-0 flex gap-4 md:gap-4 pb-2 md:pb-0 text-[16px] md:text-[18px] tracking-wide'>
                        ...
                        <div className='font-thin md:font-bold flex items-center gap-2 text-nowrap cursor-pointer' onClick={() => handleredirect('Historical')} ><span>See more</span><span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" id="right-arrow"><path fill="white" d="M13.8 24.196a1 1 0 0 0 1.414 0L21.7 17.71a.992.992 0 0 0 .292-.71.997.997 0 0 0-.292-.71l-6.486-6.486a1 1 0 0 0-1.414 1.414L19.582 17 13.8 22.782a1 1 0 0 0 0 1.414z"></path></svg>
                        </span></div>
                    </div>
                    <Swiper
                ...
                <div className='movies_scroller bg-black text-white   mb-[43px] md:mb-[0px] relative' onMouseEnter={() => onmouseenters()}>
                    <div className='font-bold flex  pr-3 md:pr-0 gap-4 md:gap-4 md:pb-0 text-[15px] md:text-[18px] tracking-wide'>
                        ...
                        <div className='font-thin md:font-bold flex items-center gap-2 text-nowrap cursor-pointer' onClick={() => handleredirect('action')} ><span>See more</span><span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" id="right-arrow"><path fill="white" d="M13.8 24.196a1 1 0 0 0 1.414 0L21.7 17.71a.992.992 0 0 0 .292-.71.997.997 0 0 0-.292-.71l-6.486-6.486a1 1 0 0 0-1.414 1.414L19.582 17 13.8 22.782a1 1 0 0 0 0 1.414z"></path></svg>
                        </span></div>
                    </div>
                    <Swiper
                ...
                <div className='movie_scroller bg-black text-white  mb-[43px]  md:mb-[0px] relative ' onMouseEnter={() => zIndexchange()}>
                    <div className='font-bold pr-3 md:pr-0 flex gap-4 md:gap-4 pb-2 md:pb-0 text-[16px] md:text-[18px] tracking-wide'>
                        ...
                        <div className='font-thin md:font-bold flex items-center gap-2 text-nowrap cursor-pointer' onClick={() => handleredirect('hindi')} ><span>See more</span><span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" id="right-arrow"><path fill="white" d="M13.8 24.196a1 1 0 0 0 1.414 0L21.7 17.71a.992.992 0 0 0 .292-.71.997.997 0 0 0-.292-.71l-6.486-6.486a1 1 0 0 0-1.414 1.414L19.582 17 13.8 22.782a1 1 0 0 0 0 1.414z"></path></svg>
                        </span></div>
                    </div>
                    <Swiper
                ...
                <div className='movies_scroller bg-black text-white   mb-[43px] md:mb-[0px] relative' onMouseEnter={() => onmouseenters()}>
                    <div className='font-bold flex  pr-3 md:pr-0 gap-4 md:gap-4 md:pb-0 text-[15px] md:text-[18px] tracking-wide'>
                        ...
                        <div className='font-thin md:font-bold flex items-center gap-2 text-nowrap cursor-pointer' onClick={() => handleredirect('punjabi')} ><span>See more</span><span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" id="right-arrow"><path fill="white" d="M13.8 24.196a1 1 0 0 0 1.414 0L21.7 17.71a.992.992 0 0 0 .292-.71.997.997 0 0 0-.292-.71l-6.486-6.486a1 1 0 0 0-1.414 1.414L19.582 17 13.8 22.782a1 1 0 0 0 0 1.414z"></path></svg>
                        </span></div>
                    </div>
                    <Swiper
                ...
                <div className='movie_scroller bg-black text-white  mb-[43px] md:mb-[0px] relative ' onMouseEnter={() => zIndexchange()}>
                    <div className='font-bold pr-3 md:pr-0 flex gap-4 md:gap-4 pb-2 md:pb-0 text-[16px] md:text-[18px] tracking-wide'>
                        ...
                        <div className='font-thin md:font-bold flex items-center gap-2 text-nowrap cursor-pointer' onClick={() => handleredirect('drama')} ><span>See more</span><span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" id="right-arrow"><path fill="white" d="M13.8 24.196a1 1 0 0 0 1.414 0L21.7 17.71a.992.992 0 0 0 .292-.71.997.997 0 0 0-.292-.71l-6.486-6.486a1 1 0 0 0-1.414 1.414L19.582 17 13.8 22.782a1 1 0 0 0 0 1.414z"></path></svg>
                        </span></div>
                    </div>
                    <Swiper
                ...
                <div className='movies_scroller bg-black text-white   mb-[43px] md:mb-[0px] relative' onMouseEnter={() => onmouseenters()}>
                    <div className='font-bold flex  pr-3 md:pr-0 gap-4 md:gap-4 md:pb-0 text-[15px] md:text-[18px] tracking-wide'>
                        <div className=' flex-wrap flex items-center'><span className='text-azonblue mr-1'>Prime</span> <span> Romantic Movies</span></div>
                        <div className='font-thin md:font-bold flex items-center gap-2 text-nowrap cursor-pointer' onClick={() => handleredirect('kids')} ><span>See more</span><span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" id="right-arrow"><path fill="white" d="M13.8 24.196a1 1 0 0 0 1.414 0L21.7 17.71a.992.992 0 0 0 .292-.71.997.997 0 0 0-.292-.71l-6.486-6.486a1 1 0 0 0-1.414 1.414L19.582 17 13.8 22.782a1 1 0 0 0 0 1.414z"></path></svg>
                        </span></div>
                    </div>
