...
const firestick = () => {
    ...
    return (
        <div>
            ...
            {/* {feedbackup && (
                <div className='feedback_wrapper fixed bottom-0 h-[100px] w-full text-white z-10 transition duration-500'>
