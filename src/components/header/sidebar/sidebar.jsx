...
0 -40 -33 -80 -72 l-73 -72 -73 72 c-73 73 -87 82 -87 59z"/>
                                    ...
                                    <ul className='mt-[13px] flex flex-col gap-[3px] bg-inputbgcolor text-azongray  w-[100vw] ml-[-36px] z-10 '>
                                        <li className='p-3 pt-[13px] pl-[48px]'>Action and adventure</li>
                                        <li className='p-3 pl-[48px]'>Anime</li>
                                        <li className='p-3 pl-[48px]'>Comedy</li>
                                        <li className='p-3 pl-[48px]'>Documentary</li>
                                        <li className='p-3 pl-[48px]'>Drama</li>
                                        <li className='p-3 pl-[48px]'>Kids</li>
                                        <li className='p-3 pl-[48px]'>Mystery and thrillers</li>
                                        <li className='p-3 pl-[48px]'>Romance</li>
                                        <li className='p-3 pl-[48px]'>Science fiction</li>
                                    </ul>
                                </li>
                            </ul>
...
0 -40 -33 -80 -72 l-73 -72 -73 72 c-73 73 -87 82 -87 59z"/>
                                    ...
                                    <ul className='mt-[13px] flex flex-col gap-[3px] bg-inputbgcolor text-azongray  w-[100vw] ml-[-36px] z-10 '>
                                        <li className='p-3 pt-[13px] pl-[48px]'>Hindi</li>
                                        <li className='p-3 pl-[48px]'>English</li>
                                        <li className='p-3 pl-[48px]'>Telugu</li>
                                        <li className='p-3 pl-[48px]'>Tamil</li>
                                        <li className='p-3 pl-[48px]'>Malayalam</li>
                                        <li className='p-3 pl-[48px]'>Kannada</li>
                                        <li className='p-3 pl-[48px]'>Marathi</li>
                                        <li className='p-3 pl-[48px]'>Punjabi</li>
                                        <li className='p-3 pl-[48px]'>Gujarati</li>
                                        <li className='p-3 pl-[48px]'>Bengali</li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
